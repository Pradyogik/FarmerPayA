    ...
    <View style={{flex:1}}>
      ...
      >
        ...
        <View style={{ justifyContent: 'center', flexDirection: 'row' }}>
          ...
          >
            <Text style={{ fontFamily: 'Inter', fontSize: 14, color: '#fff' }}>
              Abhishek Agrahari
            </Text>
          </LinearGradient>
        </View>
        ...
        >
          <Text style={{ fontFamily: 'Inter', fontSize: 12, color: '#fff' }}>
        ...
        >
          <SbiIcon />
          <Text style={{ fontFamily: 'Inter', fontSize: 10, color: '#fff' }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
          <LinearGradient
            colors={['rgba(239, 239, 239, 0.12)', 'rgba(255, 255, 255, 0.016)']}
            start={{ x: 0.25, y: 0 }}
            end={{ x: 1, y: 1 }}
            style={{
              width: 'auto',
      ...
      >
        ...
        >
          <Text style={{ color: '#252525', fontSize: 12 }}>
            Scannable on these apps:{' '}
          </Text>
          <PhonePeIcon />
          <GooglePayIcon />
          <PaytmIcon />
